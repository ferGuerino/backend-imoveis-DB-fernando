...
export class createSchedule1678217596235 implements MigrationInterface {
    name = 'createSchedule1678217596235'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "schedules_users_properties" ("id" SERIAL NOT NULL, "data" date NOT NULL DEFAULT now(), "hour" character varying NOT NULL, "realEstateId" integer, "userId" integer, CONSTRAINT "PK_751450246dee9abc82a47dabc4c" PRIMARY KEY ("id"))`);
